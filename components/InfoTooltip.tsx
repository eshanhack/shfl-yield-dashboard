...
export const TOOLTIPS = {
  ...
  apy: "Annual Percentage Yield - ESTIMATED yearly return based on historical lottery payouts. Excludes jackpot winnings. Past performance does not guarantee future results. This calculation may be inaccurate - do not rely on it for decisions. [Calculated from: Historical draw data]",
  ngr: "Net Gaming Revenue - LIVE data showing casino profit after paying out winnings. 15% of Shuffle.com's NGR goes to the lottery prize pool each week. Data may be inaccurate or delayed. [Source: Shuffle.com API]",
  ggr: "Gross Gaming Revenue - ESTIMATED value (NGR × 2). Total amount wagered minus winnings paid. NGR is roughly half of GGR after operating costs. This is an estimate and may be inaccurate. [Calculated]",
  prizePool: "The total prize pool for this week's lottery. LIVE data from Shuffle API. Built from 15% of weekly NGR plus accumulated jackpot. Data may be inaccurate or delayed. [Source: Shuffle.com API]",
  jackpot: "The Division 1 prize, won by matching all 5 numbers + the powerball. If no one wins, it rolls over to next week. LIVE data - may be inaccurate or delayed. [Source: Shuffle.com API]",
  ...
  yield: "ESTIMATED winnings from divisions 2-9 (excluding jackpot). Based on your share of total tickets and the prize pool distribution. This calculation may be inaccurate - do not rely on it for decisions. [Calculated from: Draw data]",
  shuffle: "Shuffle.com is a licensed cryptocurrency casino. Note: This dashboard is NOT affiliated with Shuffle.com. All data shown may be inaccurate. [Disclaimer]",
  sensitivity: "PROJECTED yield if NGR (casino revenue) or SHFL price moves up or down from current levels. These projections may be inaccurate - for informational purposes only, not financial advice. [Calculated]",
  ev: "Expected Value - CALCULATED average return per ticket based on probabilities. For purchased tickets, 85% of sales go to prize pool (15% house edge). This calculation may be inaccurate - do not rely on it for decisions. [Calculated]",
  ...
  jackpotReplenishment: "🎰 JP Badge - This week's NGR was adjusted because the previous week's jackpot was won. Most of the NGR went to replenishing the jackpot (insurance), not staker yield. The expected yield shown is adjusted to reflect only the non-jackpot portion. This calculation may be inaccurate. [Calculated]",
};
